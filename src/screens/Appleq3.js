...
// const Drawer = createDrawerNavigator();
  ...
  export default function Appleq3({navigation,route})
  {
    const optionAppleq31="LessThanHalf"
    const optionAppleq32="MoreThanHalf"
    const optionAppleq33="NoPatch"
          ...
          <View style={styles.textview}>
            ...
            <Pressable style={styles.boxnumber}>
              ...
              <Text style={styles.question}>
                    Fruit has spots and patches from outside?
              </Text>
              <Pressable style={styles.box1}
                onPress={()=>navigation.navigate('Appleq4',{
                  paramKey4:route.params.paramKey2,
                  paramKey5:route.params.paramKey3,
                  paramKey6:optionAppleq31
                 })}
              >
                    <Text style={styles.text1}>Less than half</Text>
              </Pressable>
              <Pressable style={styles.box2}
                onPress={()=>navigation.navigate('Appleq4',{
                  paramKey4:route.params.paramKey2,
                  paramKey5:route.params.paramKey3,
                  paramKey6:optionAppleq32
                 })}
              >
                    <Text style={styles.text1}>More than half</Text>
            </Pressable>
            <Pressable style={styles.box3}
              onPress={()=>navigation.navigate('Appleq4',{
                paramKey4:route.params.paramKey2,
                paramKey5:route.params.paramKey3,
                paramKey6:optionAppleq33
               })}
            >
