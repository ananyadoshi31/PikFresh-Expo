...
// );
  ...
  export default function Bananaq1({navigation})
  {

    const optionBananaq11="Black"
    const optionBananaq12="Brown"
    const optionBananaq13="Green"
    return (
        <View
          ...
          <View style={styles.textview}>
            ...
            <Pressable style={styles.boxnumber}>
              ...
              <Text style={styles.question}>
                What is the color of stem?
              </Text>
              <Pressable 
                style={styles.box1}
                onPress={()=>navigation.navigate('Bananaq2',{
                  paramKey1:optionBananaq11
                 })}
              >
