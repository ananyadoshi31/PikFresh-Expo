...
// const Drawer = createDrawerNavigator();
  ...
  export default function Appleq4({navigation,route})
  {

    const optionAppleq41="YesSmell"
    const optionAppleq42="NoSmell"
        ...
        <View style={[styles.card, styles.shadowProp]}>  
          ...
          <View style={styles.textview}>
            ...
            <Pressable style={styles.boxnumber}>
              ...
              Does the fruit has strong sweet smell?
              </Text>
              <Pressable style={styles.box1}
                onPress={()=>navigation.navigate('ReportApple',{
                  paramKey7:route.params.paramKey4,
                  paramKey8:route.params.paramKey5,
                  paramKey9:route.params.paramKey6,
                  paramKey10:optionAppleq41
                 })}
              >
